...
> This project is currently in the **conceptual architecture phase**.
> The codebase is subject to heavy refactoring as I experiment with the PAD algorithm and Vector Middleware logic.
